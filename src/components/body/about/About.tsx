  ...
  return (
    <section id="about" className="container mx-auto max-w-content pt-20">
      ...
      >
        ...
        <div className="flex flex-col items-center md:justify-center gap-12 mt-7 md:flex-row w-full">
          ...
          <div className="group/developer w-[300px] h-[317px] md:w-[160px] md:h-[172px] bg-black/20 p-2 rounded-md border-2 border-solid border-transparent hover:border-primary duration-500">
